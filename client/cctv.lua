      ...
      if CanCCTV then
        ...
        local function CreateInstuctionScaleform(scaleform)
          ...
          if Config.CCTV.PictureWebook ~= "" then
            ...
            ScaleformMovieMethodAddParamPlayerNameString(GetControlInstructionalButton(1, Config.CCTV.Controls
            .Screenshot, true))
          ...
          ScaleformMovieMethodAddParamPlayerNameString(GetControlInstructionalButton(1, Config.CCTV.Controls.NightVision,
            true))
        ...
        cctvcam = CreateCamWithParams("DEFAULT_SCRIPTED_CAMERA",
          vector3(Property.Entrance.x, Property.Entrance.y, Property.Entrance.z + Config.CCTV.HeightAboveDoor), 0, 0, 0,
          Config.CCTV.FOV)
