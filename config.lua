...
Config.Raiding = {
  ...
  ItemRequired = {          -- Item Required to Raid -- Remove To Disable
    ...
    name = "weapon_hammer", -- Item Name Default: "bread"
    label = "Marteau",      -- Item label Default: "Bread"
...
Config.Garage = {
  ...
  MySQLquery =
  "UPDATE `owned_vehicles` SET `stored` = ? WHERE `plate` = ?" -- MySQL Query to store vehicles `?` = True/false, Vehicle Plate
}
...
if IsDuplicityVersion() then
  Config.Logs = {
    Webhook =
    "https://discord.com/api/webhooks/1206304023712370790/hh4c7kMyj1tliPSzavBvWieZQTACJLHWXbxI99CNsh8uFXDXN1kpErzALDYgtIXQjOKu",
    LogLevel = 3
...
Config.PlayerManagement = {
  ...
  joblabel = "Agence Immo",            -- Job Label Default: "Estate Agent"
  ...
  Permissions = {                         -- Minimum Grade Required for Action
    ...
    ToggleGarage = 0,                     -- Change Garage Settings
  ...
  Locations = {
    Entrance = vector3(-710.0845, 268.7217, 0.10796),    -- Entrance Location Default: vector3( -199.151, -575.000,  39.489 )
    Exit = vector3(-710.0845, 268.7217, 0.10796),        -- Exit Location (Interior Location) Default: vector3( -141.226, -614.166,  167.820 )
    Properties = vector3(-710.0845, 268.7217, 82.10796), -- Property Management Menu Default: vector3(-138.9228, -634.1255, 167.8504)
  }
}
...
Config.Interiors = {
  IPL = {
    ...
    {
      label = "Petit Appart",
      value = "turktwostory_milo_",
      positions = {
        Wardrobe = vector3(48.74109, -981.2739, -90.61583),
        Storage = vector3(51.49505, -981.7407, -93.49357), -- Only Works with Ox Inventory
      },
      type = "ipl",
      pos = vector3(48.52442, -974.425, -93.49358)
    },
    {
      label = "Modern Appart 2",
      value = "apa_v_mp_h_01_c",
      positions = {
        Wardrobe = vector3(-797.9943, 328.4079, 190.7158),
        Storage = vector3(-796.5809, 328.18, 187.3131), -- Only Works with Ox Inventory
      },
      type = "ipl",
      pos = vector3(-786.9563, 315.6229, 187.9136)
    },
    {
      label = "Modern Appart 3",
      value = "apa_v_mp_h_01_b",
      positions = {
        Wardrobe = vector3(-763.1806, 329.3627, 199.4863),
        Storage = vector3(-764.4658, 329.395, 196.086), -- Only Works with Ox Inventory
      },
      type = "ipl",
      pos = vector3(-773.9941, 342.0178, 196.6862)
    },
    {
      label = "Black&White",
      value = "d1n_hitech_shell",
      positions = {
        Wardrobe = vector3(359.4435, -157.0791, 73.64798),
        Storage = vector3(353.5906, -155.8708, 73.64798), -- Only Works with Ox Inventory
      },
      type = "ipl",
      pos = vector3(354.698, -151.0091, 73.64798)
    },
  },
  Shells = {
    --[[{x="355.3885" y="-156.521652" z="74.23194"
      label = "Michael House",
      value = "shell_michael",
      positions = {
